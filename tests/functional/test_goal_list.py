...
def test_goal_list_resource_with_post(client):
    ...
    assert response.json['name'] == 'Retire Funding'
    assert response.json['target'] == 30000000
    assert response.json['start_date'] == '1/1/2023'
    assert response.json['end_date'] == '1/1/2023'
